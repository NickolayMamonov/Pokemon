...
class FilterPokemonUseCaseTest {
    ...
    @Test
    fun `filter by empty query returns all pokemon`() =
        runTest {
    ...
    @Test
    fun `filter by pokemon name returns matching pokemon`() =
        runTest {
    ...
    @Test
    fun `filter by pokemon id returns matching pokemon`() =
        runTest {
    ...
    @Test
    fun `filter by pokemon type returns matching pokemon`() =
        runTest {
    ...
    @Test
    fun `filter by selected types returns matching pokemon`() =
        runTest {
    ...
    @Test
    fun `filter by multiple selected types returns pokemon with all types`() =
        runTest {
    ...
    @Test
    fun `filter by min hp returns pokemon with hp greater than or equal to threshold`() =
        runTest {
    ...
    @Test
    fun `filter by max hp returns pokemon with hp less than or equal to threshold`() =
        runTest {
    ...
    @Test
    fun `sort by name ascending returns alphabetically sorted pokemon`() =
        runTest {
    ...
    @Test
    fun `sort by name descending returns reverse alphabetically sorted pokemon`() =
        runTest {
    ...
    @Test
    fun `sort by id ascending returns id sorted pokemon`() =
        runTest {
    ...
    @Test
    fun `sort by attack descending returns attack sorted pokemon`() =
        runTest {
    ...
    private fun createTestPokemon(
        ...
        types =
            types.mapIndexed { index, typeName ->
