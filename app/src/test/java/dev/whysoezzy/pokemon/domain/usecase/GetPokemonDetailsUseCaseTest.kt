...
class GetPokemonDetailsUseCaseTest {
    ...
    @Test
    fun `invoke with valid id returns success result from repository`() = runTest {
        val pokemonId = "1"
    ...
    @Test
    fun `invoke with different pokemon ids calls repository with correct values`() = runTest {
    ...
    @Test
    fun `invoke with string id calls repository correctly`() = runTest {
    ...
    @Test
    fun `invoke with empty id calls repository correctly`() = runTest {
        val pokemonId = ""
